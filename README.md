...
|------------------|----|-----|------|------|---------|---------|
| mceliece348864   | 12 | 64  | 3488 | 768  | 0 – 2.0 | ✓       |
...
```bash
python tests/tests.py mceliece348864       # ~13 minutes
python tests/tests.py mceliece460896       # ~3 heures
```
...
3. **Pierre-Louis Cayrel et al.** SAC 2025 (à paraître).
...
Stage encadré par **Pierre-Louis Cayrel**  
